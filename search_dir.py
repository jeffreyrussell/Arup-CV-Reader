...
def search(data):
    ...
    incorrect_folders = ['Assets', 'assets', 'Headshots', 'Licences and Certifications', 'SF330', 'ss', 'SS', 'Superseded',
                         'superseded', 'Superceded', 'superceded', 'sub', 'sub2', '_Admin', '_Resume Folder Setup', '_Skills', 'Aviation',
                         'CVs for Processing', 'Processed', 'Email', 'proposals with detailed CVs', 'zz_leavers', '_Leavers', 'Previous Versions', 'Tailored CVs']
    ...
    for root, dirs, files in os.walk(parent_folder):
        ...
        for file in files:
            ...
            if file.endswith(".docx"):
                if root.find("_Leavers") != -1 or root.find("zz_leavers") != -1 or root.find("Assets") != -1:
