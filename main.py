...
def main(data):  # For debugging. This function runs the script without the Gooey GUI. Note that this function is used if toggle_gooey = False.
    ...
    data['parent_folder'] = r"C:\Users\Jeffrey.Russell\Desktop\input3"  # Use r"[path]" format
    data['output_folder'] = r"C:\Users\Jeffrey.Russell\Desktop\output"  # Use r"[path]" format
    return data
